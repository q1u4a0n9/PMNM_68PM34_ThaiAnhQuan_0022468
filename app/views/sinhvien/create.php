<div class="container" style="max-width:500px;">
    ...
    <form id="form-create-sv" action="/QLSV/public/sinhvien/store" method="post">
...
<script>
    const validation = new JustValidate('#form-create-sv', {
    ...
    validation
        ...
        .onSuccess(() => {
            document.getElementById('form-create-sv').submit();
        });
</script>
